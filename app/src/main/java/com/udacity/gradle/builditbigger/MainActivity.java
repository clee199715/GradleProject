...
import com.example.android.jokes.Joke;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("test this", Joke.generateRandomJoke());

        EndpointsAsyncTask handler = new EndpointsAsyncTask();
        handler.execute(new Pair<Context, String>(this, "Manfred"));
    }
    ...
    public void launchJokeActivity(View view) {
        ...
        String joke = Joke.generateRandomJoke();
